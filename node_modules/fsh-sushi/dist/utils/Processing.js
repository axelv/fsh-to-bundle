...
exports.checkSushiVersion = exports.getLatestSushiVersion = exports.getLocalSushiVersion = exports.getFilesRecursive = exports.init = exports.writePreprocessedFSH = exports.writeFHIRResources = exports.checkNullValuesOnArray = exports.fillTank = exports.getRawFSHes = exports.loadAutomaticDependencies = exports.loadExternalDependencies = exports.updateExternalDependencies = exports.readConfig = exports.ensureOutputDir = exports.findInputDir = exports.hasFshFiles = exports.ensureInputDir = exports.isSupportedFHIRVersion = exports.AUTOMATIC_DEPENDENCIES = void 0;
...
function updateExternalDependencies(config) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const promises = config.dependencies.map((dep) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (dep.version != 'current' && dep.version != 'dev') {
                ...
                if (process_1.default.env.FPL_REGISTRY) {
                    try {
                        res = yield (0, axiosUtils_1.axiosGet)(`${process_1.default.env.FPL_REGISTRY}/${dep.packageId}`);
                        latestVersion = (_c = (_b = res === null || res === void 0 ? void 0 : res.data) === null || _b === void 0 ? void 0 : _b['dist-tags']) === null || _c === void 0 ? void 0 : _c.latest;
                    }
                    catch (e) {
                    ...
                    try {
                        res = yield (0, axiosUtils_1.axiosGet)(`https://packages.fhir.org/${dep.packageId}`);
                        latestVersion = (_e = (_d = res === null || res === void 0 ? void 0 : res.data) === null || _d === void 0 ? void 0 : _d['dist-tags']) === null || _e === void 0 ? void 0 : _e.latest;
                    }
                    catch (e) {
                        try {
                            res = yield (0, axiosUtils_1.axiosGet)(`https://packages2.fhir.org/packages/${dep.packageId}`);
                            latestVersion = (_g = (_f = res === null || res === void 0 ? void 0 : res.data) === null || _f === void 0 ? void 0 : _f['dist-tags']) === null || _g === void 0 ? void 0 : _g.latest;
                        }
                        catch (e) {
...
function loadExternalDependencies(defs, config) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield loadAutomaticDependencies(fhirVersion, dependencies, defs);
        // Then load configured dependencies, with FHIR core last so it has highest priority in resolution
        yield loadConfiguredDependencies(dependencies, fhirVersion, config.filePath, defs);
    });
}
exports.loadExternalDependencies = loadExternalDependencies;
function loadAutomaticDependencies(fhirVersion, configuredDependencies, defs) {
    var _a, _b, _c;
    return __awaiter(this, void 0, void 0, function* () {
        // Load dependencies serially so dependency loading order is predictable and repeatable
        for (let dep of exports.AUTOMATIC_DEPENDENCIES) {
            ...
            if (!alreadyConfigured) {
                try {
                    ...
                    yield (0, fhir_package_loader_1.mergeDependency)(dep.packageId, dep.version, defs, undefined, FSHLogger_1.logMessage);
                }
                catch (e) {
...
function loadConfiguredDependencies(dependencies, fhirVersion, configPath, defs) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        // Load dependencies serially so dependency loading order is predictable and repeatable
        for (const dep of dependencies) {
            if (dep.version == null) {
                ...
                yield (0, fhirdefs_1.loadSupplementalFHIRPackage)(EXT_PKG_TO_FHIR_PKG_MAP[dep.packageId], defs);
            }
            else {
                yield (0, fhir_package_loader_1.mergeDependency)(dep.packageId, dep.version, defs, undefined, FSHLogger_1.logMessage).catch(e => {
...
function init() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        ['name', 'id', 'canonical', 'status', 'version'].forEach(field => {
            const userValue = readline_sync_1.default.question(`${(0, lodash_1.upperFirst)(field)} (Default: ${configDoc.get(field)}): `);
            if (userValue) {
                if (field === 'status') {
        ...
        ['name', 'url'].forEach(field => {
            const userValue = readline_sync_1.default.question(`Publisher ${(0, lodash_1.upperFirst)(field)} (Default: ${configDoc.get('publisher').get(field)}): `);
            if (userValue) {
...
function getLatestSushiVersionFallback() {
    return __awaiter(this, void 0, void 0, function* () {
        FSHLogger_1.logger.info('Attempting fallback to determine version of sushi.');
        try {
            const res = yield (0, axiosUtils_1.axiosGet)('https://registry.npmjs.org/fsh-sushi');
...
function getLatestSushiVersion() {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (latestVer === undefined) {
            latestVer = yield getLatestSushiVersionFallback();
        }
        return latestVer;
    });
}
exports.getLatestSushiVersion = getLatestSushiVersion;
function checkSushiVersion() {
    return __awaiter(this, void 0, void 0, function* () {
        const latest = yield getLatestSushiVersion();
