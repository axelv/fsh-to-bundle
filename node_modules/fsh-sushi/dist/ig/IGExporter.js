...
class IGExporter {
    ...
    addConfiguredPage(page, target) {
        ...
        if (page.nameUrl) {
            ...
            const igPage = Object.assign(Object.assign({ nameUrl: `${name}.html`, title: (_a = page.title) !== null && _a !== void 0 ? _a : (0, title_case_1.titleCase)((0, lodash_1.words)(name).join(' ')), generation: (_b = page.generation) !== null && _b !== void 0 ? _b : (fileType === 'md' ? 'markdown' : 'html') }, (page.extension && { extension: page.extension })), (page.modifierExtension && { modifierExtension: page.modifierExtension }));
    ...
    addMenuXML(igPath) {
        ...
        if ((0, fs_extra_1.existsSync)(menuXMLDefaultPath) && this.config.menu) {
    ...
    addPackageResource(referenceKey, pkgResource, configResource) {
        ...
        if (pkgResource instanceof fhirtypes_1.InstanceDefinition) {
            newResource.name =
                (_b = (_a = configResource === null || configResource === void 0 ? void 0 : configResource.name) !== null && _a !== void 0 ? _a : pkgResource._instanceMeta.title) !== null && _b !== void 0 ? _b : pkgResource._instanceMeta.name;
            newResource.description =
                (_c = configResource === null || configResource === void 0 ? void 0 : configResource.description) !== null && _c !== void 0 ? _c : pkgResource._instanceMeta.description;
            newResource._linkRef = pkgResource.id;
        }
        else {
            newResource.name =
                (_f = (_e = (_d = configResource === null || configResource === void 0 ? void 0 : configResource.name) !== null && _d !== void 0 ? _d : pkgResource.title) !== null && _e !== void 0 ? _e : pkgResource.name) !== null && _f !== void 0 ? _f : pkgResource.id;
            newResource.description = (_g = configResource === null || configResource === void 0 ? void 0 : configResource.description) !== null && _g !== void 0 ? _g : pkgResource.description;
            newResource._linkRef = pkgResource.name;
        }
        if ((_h = configResource === null || configResource === void 0 ? void 0 : configResource.fhirVersion) === null || _h === void 0 ? void 0 : _h.length) {
        ...
        if (configResource === null || configResource === void 0 ? void 0 : configResource.exampleCanonical) {
            ...
            const metaProfileUrls = (_k = (_j = pkgResource.meta) === null || _j === void 0 ? void 0 : _j.profile) !== null && _k !== void 0 ? _k : [];
            const exampleUrl = [...metaProfileUrls, (_l = pkgResource._instanceMeta.instanceOfUrl) !== null && _l !== void 0 ? _l : ''].find(url => {
        ...
        if ((_m = configResource === null || configResource === void 0 ? void 0 : configResource.extension) === null || _m === void 0 ? void 0 : _m.length) {
            newResource.extension = configResource.extension;
        }
        if (pkgResource instanceof fhirtypes_1.InstanceDefinition &&
            pkgResource._instanceMeta.sdKind === 'logical' &&
            !((_o = configResource === null || configResource === void 0 ? void 0 : configResource.extension) === null || _o === void 0 ? void 0 : _o.some(ext => ext.url === 'http://hl7.org/fhir/StructureDefinition/implementationguide-resource-format'))) {
            // Logical instances should add a special extension. See: https://fshschool.org/docs/sushi/tips/#instances-of-logical-models
            newResource.extension = (_p = newResource.extension) !== null && _p !== void 0 ? _p : [];
    ...
    addPredefinedResources() {
        ...
        if (pathResources) {
            pathResourceDirectories = pathResources
                .map(directoryPath => path_1.default.join(this.inputPath, directoryPath))
                .filter(directoryPath => (0, fs_extra_1.existsSync)(directoryPath));
            ...
            if ((0, fs_extra_1.existsSync)(dirPath)) {
                ...
                for (const file of files) {
                    ...
                    if (resourceJSON) {
                        ...
                        const hasBinaryExampleReference = ((_c = this.config.resources) !== null && _c !== void 0 ? _c : []).some(resource => {
                            var _a, _b;
                            return ((_a = resource.reference) === null || _a === void 0 ? void 0 : _a.reference) === `Binary/${resourceJSON.id}` &&
                                ...
                                ((_b = resource.extension) === null || _b === void 0 ? void 0 : _b.some(e => e.url ===
                        ...
                        if ((configResource === null || configResource === void 0 ? void 0 : configResource.omit) !== true && !hasBinaryExampleReference) {
                            ...
                            newResource.description =
                                (_f = (_e = (_d = configResource === null || configResource === void 0 ? void 0 : configResource.description) !== null && _d !== void 0 ? _d : metaExtensionDescription) !== null && _e !== void 0 ? _e : existingDescription) !== null && _f !== void 0 ? _f : (CONFORMANCE_AND_TERMINOLOGY_RESOURCES.has(resourceJSON.resourceType)
                            ...
                            if (path_1.default.basename(dirPath) === 'examples') {
                                newResource.name =
                                    (_j = (_h = (_g = configResource === null || configResource === void 0 ? void 0 : configResource.name) !== null && _g !== void 0 ? _g : metaExtensionName) !== null && _h !== void 0 ? _h : existingName) !== null && _j !== void 0 ? _j : resourceJSON.id;
                                ...
                                if (configResource === null || configResource === void 0 ? void 0 : configResource.exampleCanonical) {
                                    ...
                                    const exampleUrl = (_l = (_k = resourceJSON.meta) === null || _k === void 0 ? void 0 : _k.profile) === null || _l === void 0 ? void 0 : _l.find(url => {
                                        var _a;
                                        const [baseUrl, version] = url.split('|', 2);
                                ...
                                newResource.name =
                                    (_r = (_q = (_p = (_o = (_m = configResource === null || configResource === void 0 ? void 0 : configResource.name) !== null && _m !== void 0 ? _m : metaExtensionName) !== null && _o !== void 0 ? _o : existingResource === null || existingResource === void 0 ? void 0 : existingResource.name) !== null && _p !== void 0 ? _p : title) !== null && _q !== void 0 ? _q : name) !== null && _r !== void 0 ? _r : resourceJSON.id;
                                newResource._linkRef = name !== null && name !== void 0 ? name : resourceJSON.id;
                            }
                            if ((_s = configResource === null || configResource === void 0 ? void 0 : configResource.extension) === null || _s === void 0 ? void 0 : _s.length) {
                                newResource.extension = configResource.extension;
                            }
                            if (existingIndex >= 0) {
