...
class FSHParser extends antlr4_1.default.Parser {
    ...
    cardRule() {
        ...
        this.enterRule(localctx, 86, FSHParser.RULE_cardRule);
        var _la = 0; // Token type
        try {
            this.enterOuterAlt(localctx, 1);
            this.state = 475;
    ...
    flagRule() {
        ...
        this.enterRule(localctx, 88, FSHParser.RULE_flagRule);
        var _la = 0; // Token type
        try {
            this.enterOuterAlt(localctx, 1);
            this.state = 484;
    ...
    valueSetRule() {
        ...
        this.enterRule(localctx, 90, FSHParser.RULE_valueSetRule);
        var _la = 0; // Token type
        try {
            this.enterOuterAlt(localctx, 1);
            this.state = 498;
    ...
    fixedValueRule() {
        ...
        this.enterRule(localctx, 92, FSHParser.RULE_fixedValueRule);
        var _la = 0; // Token type
        try {
            this.enterOuterAlt(localctx, 1);
            this.state = 505;
    ...
    containsRule() {
        ...
        this.enterRule(localctx, 94, FSHParser.RULE_containsRule);
        var _la = 0; // Token type
        try {
            this.enterOuterAlt(localctx, 1);
            this.state = 512;
    ...
    onlyRule() {
        ...
        this.enterRule(localctx, 96, FSHParser.RULE_onlyRule);
        var _la = 0; // Token type
        try {
            this.enterOuterAlt(localctx, 1);
            this.state = 523;
    ...
    obeysRule() {
        ...
        this.enterRule(localctx, 98, FSHParser.RULE_obeysRule);
        var _la = 0; // Token type
        try {
            this.enterOuterAlt(localctx, 1);
            this.state = 534;
    ...
    caretValueRule() {
        ...
        this.enterRule(localctx, 100, FSHParser.RULE_caretValueRule);
        var _la = 0; // Token type
        try {
            this.enterOuterAlt(localctx, 1);
            this.state = 547;
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
            if (((((_la - 24)) & ~0x1f) == 0 && ((1 << (_la - 24)) & ((1 << (FSHParser.KW_MS - 24)) | (1 << (FSHParser.KW_SU - 24)) | (1 << (FSHParser.KW_TU - 24)) | (1 << (FSHParser.KW_NORMATIVE - 24)) | (1 << (FSHParser.KW_DRAFT - 24)) | (1 << (FSHParser.KW_FROM - 24)) | (1 << (FSHParser.KW_CONTAINS - 24)) | (1 << (FSHParser.KW_NAMED - 24)) | (1 << (FSHParser.KW_AND - 24)) | (1 << (FSHParser.KW_ONLY - 24)) | (1 << (FSHParser.KW_OR - 24)) | (1 << (FSHParser.KW_OBEYS - 24)) | (1 << (FSHParser.KW_TRUE - 24)) | (1 << (FSHParser.KW_FALSE - 24)) | (1 << (FSHParser.KW_INCLUDE - 24)) | (1 << (FSHParser.KW_EXCLUDE - 24)) | (1 << (FSHParser.KW_CODES - 24)) | (1 << (FSHParser.KW_WHERE - 24)) | (1 << (FSHParser.KW_VSREFERENCE - 24)) | (1 << (FSHParser.KW_SYSTEM - 24)) | (1 << (FSHParser.KW_CONTENTREFERENCE - 24)))) !== 0) || _la === FSHParser.NUMBER || _la === FSHParser.SEQUENCE) {
                this.state = 548;
                this.path();
            }
            this.state = 551;
    ...
    codeCaretValueRule() {
        ...
        this.enterRule(localctx, 102, FSHParser.RULE_codeCaretValueRule);
        var _la = 0; // Token type
        try {
            this.enterOuterAlt(localctx, 1);
            this.state = 555;
    ...
    mappingRule() {
        ...
        this.enterRule(localctx, 104, FSHParser.RULE_mappingRule);
        var _la = 0; // Token type
        try {
            this.enterOuterAlt(localctx, 1);
            this.state = 566;
    ...
    insertRule() {
        ...
        this.enterRule(localctx, 106, FSHParser.RULE_insertRule);
        var _la = 0; // Token type
        try {
            this.enterOuterAlt(localctx, 1);
            this.state = 578;
    ...
    codeInsertRule() {
        ...
        this.enterRule(localctx, 108, FSHParser.RULE_codeInsertRule);
        var _la = 0; // Token type
        try {
            this.enterOuterAlt(localctx, 1);
            this.state = 587;
    ...
    addCRElementRule() {
        ...
        this.enterRule(localctx, 110, FSHParser.RULE_addCRElementRule);
        var _la = 0; // Token type
        try {
            this.enterOuterAlt(localctx, 1);
            this.state = 599;
    ...
    addElementRule() {
        ...
        this.enterRule(localctx, 112, FSHParser.RULE_addElementRule);
        var _la = 0; // Token type
        try {
            this.enterOuterAlt(localctx, 1);
            this.state = 614;
    ...
    pathRule() {
        ...
        this.enterRule(localctx, 114, FSHParser.RULE_pathRule);
        try {
            this.enterOuterAlt(localctx, 1);
            this.state = 635;
            this.match(FSHParser.STAR);
    ...
    vsComponent() {
        ...
        this.enterRule(localctx, 116, FSHParser.RULE_vsComponent);
        var _la = 0; // Token type
        try {
            this.enterOuterAlt(localctx, 1);
            this.state = 638;
    ...
    vsConceptComponent() {
        ...
        this.enterRule(localctx, 118, FSHParser.RULE_vsConceptComponent);
        var _la = 0; // Token type
        try {
            this.state = 660;
            this._errHandler.sync(this);
    ...
    vsFilterComponent() {
        ...
        this.enterRule(localctx, 120, FSHParser.RULE_vsFilterComponent);
        var _la = 0; // Token type
        try {
            this.enterOuterAlt(localctx, 1);
            this.state = 662;
    ...
    vsComponentFrom() {
        ...
        this.enterRule(localctx, 122, FSHParser.RULE_vsComponentFrom);
        var _la = 0; // Token type
        try {
            this.enterOuterAlt(localctx, 1);
            this.state = 668;
    ...
    vsFromSystem() {
        ...
        this.enterRule(localctx, 124, FSHParser.RULE_vsFromSystem);
        try {
            this.enterOuterAlt(localctx, 1);
            this.state = 681;
    ...
    vsFromValueset() {
        ...
        this.enterRule(localctx, 126, FSHParser.RULE_vsFromValueset);
        try {
            this.enterOuterAlt(localctx, 1);
            this.state = 684;
    ...
    vsFilterList() {
        ...
        this.enterRule(localctx, 128, FSHParser.RULE_vsFilterList);
        var _la = 0; // Token type
        try {
            this.enterOuterAlt(localctx, 1);
            this.state = 693;
    ...
    vsFilterDefinition() {
        ...
        this.enterRule(localctx, 130, FSHParser.RULE_vsFilterDefinition);
        var _la = 0; // Token type
        try {
            this.enterOuterAlt(localctx, 1);
            this.state = 701;
    ...
    vsFilterOperator() {
        ...
        this.enterRule(localctx, 132, FSHParser.RULE_vsFilterOperator);
        var _la = 0; // Token type
        try {
            this.enterOuterAlt(localctx, 1);
            this.state = 706;
    ...
    vsFilterValue() {
        ...
        this.enterRule(localctx, 134, FSHParser.RULE_vsFilterValue);
        try {
            this.state = 713;
            this._errHandler.sync(this);
            switch (this._input.LA(1)) {
    ...
    name() {
        ...
        this.enterRule(localctx, 136, FSHParser.RULE_name);
        var _la = 0; // Token type
        try {
            this.enterOuterAlt(localctx, 1);
            this.state = 715;
    ...
    path() {
        ...
        this.enterRule(localctx, 138, FSHParser.RULE_path);
        try {
            this.state = 720;
            this._errHandler.sync(this);
            switch (this._input.LA(1)) {
    ...
    caretPath() {
        ...
        this.enterRule(localctx, 140, FSHParser.RULE_caretPath);
        try {
            this.enterOuterAlt(localctx, 1);
            this.state = 722;
    ...
    flag() {
        ...
        this.enterRule(localctx, 142, FSHParser.RULE_flag);
        var _la = 0; // Token type
        try {
            this.enterOuterAlt(localctx, 1);
            this.state = 724;
    ...
    strength() {
        ...
        this.enterRule(localctx, 144, FSHParser.RULE_strength);
        var _la = 0; // Token type
        try {
            this.enterOuterAlt(localctx, 1);
            this.state = 726;
    ...
    value() {
        ...
        this.enterRule(localctx, 146, FSHParser.RULE_value);
        try {
            this.state = 740;
            this._errHandler.sync(this);
    ...
    item() {
        ...
        this.enterRule(localctx, 148, FSHParser.RULE_item);
        var _la = 0; // Token type
        try {
            this.enterOuterAlt(localctx, 1);
            this.state = 742;
    ...
    code() {
        ...
        this.enterRule(localctx, 150, FSHParser.RULE_code);
        var _la = 0; // Token type
        try {
            this.enterOuterAlt(localctx, 1);
            this.state = 754;
    ...
    concept() {
        ...
        this.enterRule(localctx, 152, FSHParser.RULE_concept);
        var _la = 0; // Token type
        try {
            this.enterOuterAlt(localctx, 1);
            this.state = 758;
    ...
    quantity() {
        ...
        this.enterRule(localctx, 154, FSHParser.RULE_quantity);
        var _la = 0; // Token type
        try {
            this.enterOuterAlt(localctx, 1);
            this.state = 770;
    ...
    ratio() {
        ...
        this.enterRule(localctx, 156, FSHParser.RULE_ratio);
        try {
            this.enterOuterAlt(localctx, 1);
            this.state = 775;
            this.ratioPart();
    ...
    reference() {
        ...
        this.enterRule(localctx, 158, FSHParser.RULE_reference);
        var _la = 0; // Token type
        try {
            this.enterOuterAlt(localctx, 1);
            this.state = 779;
    ...
    referenceType() {
        ...
        this.enterRule(localctx, 160, FSHParser.RULE_referenceType);
        try {
            this.enterOuterAlt(localctx, 1);
            this.state = 783;
            this.match(FSHParser.REFERENCE);
    ...
    canonical() {
        ...
        this.enterRule(localctx, 162, FSHParser.RULE_canonical);
        try {
            this.enterOuterAlt(localctx, 1);
            this.state = 785;
    ...
    ratioPart() {
        ...
        this.enterRule(localctx, 164, FSHParser.RULE_ratioPart);
        try {
            this.state = 789;
            this._errHandler.sync(this);
    ...
    bool() {
        ...
        this.enterRule(localctx, 166, FSHParser.RULE_bool);
        var _la = 0; // Token type
        try {
            this.enterOuterAlt(localctx, 1);
            this.state = 791;
    ...
    targetType() {
        ...
        this.enterRule(localctx, 168, FSHParser.RULE_targetType);
        try {
            this.state = 796;
            this._errHandler.sync(this);
            switch (this._input.LA(1)) {
    ...
    mostAlphaKeywords() {
        ...
        this.enterRule(localctx, 170, FSHParser.RULE_mostAlphaKeywords);
        var _la = 0; // Token type
        try {
            this.enterOuterAlt(localctx, 1);
            this.state = 798;
            _la = this._input.LA(1);
            if (!(((((_la - 24)) & ~0x1f) == 0 && ((1 << (_la - 24)) & ((1 << (FSHParser.KW_MS - 24)) | (1 << (FSHParser.KW_SU - 24)) | (1 << (FSHParser.KW_TU - 24)) | (1 << (FSHParser.KW_NORMATIVE - 24)) | (1 << (FSHParser.KW_DRAFT - 24)) | (1 << (FSHParser.KW_FROM - 24)) | (1 << (FSHParser.KW_CONTAINS - 24)) | (1 << (FSHParser.KW_NAMED - 24)) | (1 << (FSHParser.KW_AND - 24)) | (1 << (FSHParser.KW_ONLY - 24)) | (1 << (FSHParser.KW_OR - 24)) | (1 << (FSHParser.KW_OBEYS - 24)) | (1 << (FSHParser.KW_TRUE - 24)) | (1 << (FSHParser.KW_FALSE - 24)) | (1 << (FSHParser.KW_INCLUDE - 24)) | (1 << (FSHParser.KW_EXCLUDE - 24)) | (1 << (FSHParser.KW_CODES - 24)) | (1 << (FSHParser.KW_WHERE - 24)) | (1 << (FSHParser.KW_VSREFERENCE - 24)) | (1 << (FSHParser.KW_SYSTEM - 24)) | (1 << (FSHParser.KW_CONTENTREFERENCE - 24)))) !== 0))) {
                this._errHandler.recoverInline(this);
            }
            else {
                this._errHandler.reportMatch(this);
...
FSHParser.BRACKETED_PARAM = 76;
FSHParser.LAST_BRACKETED_PARAM = 77;
FSHParser.PLAIN_PARAM = 78;
FSHParser.LAST_PLAIN_PARAM = 79;
...
FSHParser.RULE_cardRule = 43;
FSHParser.RULE_flagRule = 44;
FSHParser.RULE_valueSetRule = 45;
FSHParser.RULE_fixedValueRule = 46;
FSHParser.RULE_containsRule = 47;
FSHParser.RULE_onlyRule = 48;
FSHParser.RULE_obeysRule = 49;
FSHParser.RULE_caretValueRule = 50;
FSHParser.RULE_codeCaretValueRule = 51;
FSHParser.RULE_mappingRule = 52;
FSHParser.RULE_insertRule = 53;
FSHParser.RULE_codeInsertRule = 54;
FSHParser.RULE_addCRElementRule = 55;
FSHParser.RULE_addElementRule = 56;
FSHParser.RULE_pathRule = 57;
FSHParser.RULE_vsComponent = 58;
FSHParser.RULE_vsConceptComponent = 59;
FSHParser.RULE_vsFilterComponent = 60;
FSHParser.RULE_vsComponentFrom = 61;
FSHParser.RULE_vsFromSystem = 62;
FSHParser.RULE_vsFromValueset = 63;
FSHParser.RULE_vsFilterList = 64;
FSHParser.RULE_vsFilterDefinition = 65;
FSHParser.RULE_vsFilterOperator = 66;
FSHParser.RULE_vsFilterValue = 67;
FSHParser.RULE_name = 68;
FSHParser.RULE_path = 69;
FSHParser.RULE_caretPath = 70;
FSHParser.RULE_flag = 71;
FSHParser.RULE_strength = 72;
FSHParser.RULE_value = 73;
FSHParser.RULE_item = 74;
FSHParser.RULE_code = 75;
FSHParser.RULE_concept = 76;
FSHParser.RULE_quantity = 77;
FSHParser.RULE_ratio = 78;
FSHParser.RULE_reference = 79;
FSHParser.RULE_referenceType = 80;
FSHParser.RULE_canonical = 81;
FSHParser.RULE_ratioPart = 82;
FSHParser.RULE_bool = 83;
FSHParser.RULE_targetType = 84;
FSHParser.RULE_mostAlphaKeywords = 85;
